...
# 1. 页面与样式配置
st.set_page_config(page_title="sukasuka七日记", page_icon="🔞", layout="wide")
st.markdown("""
    <style>
...
if 'day' not in st.session_state:
    st.session_state.update({
        ...
        'time_of_day': '白天', 'name': "？",
        'last_result': "欢迎来到魔窟。这里每一步都可能是你的祭日。",
        'death_reason': ""
    })
if 'day' not in st.session_state:
    st.session_state.update({
...
EVENTS = {
    "白天_老老实实待着": [
        ("女王派人送来一碗‘虎鞭鹿茸汤’，你喝完当场七窍流血，抱着身边的侍女摇晃起来。", -20, 10, False),
        ("你在屋里导管，不小心抠破了皮感染了‘sukasuka真菌’，吊肿得很大，弄的大家都很痛。", -10, 0, False),
        ("你正在发呆，女王突然闯入强行让你表演下体碎大石，你因基本功不扎实险些断子绝孙。", -30, 15, False),
        ("你因为太老实，被路过的壮汉当成软柿子，抓去快活了一天，肛门松弛度增加。", -15, -5, False)
    ],
    "白天_出去闲逛": [
        ("你路过禁地‘榨汁间’，好奇往里看了一眼，结果被保安发现，当场被做成了肉饼。", 0, 0, True),  # 暴毙
        ("你遇到了一个奶0，他娇媚地看着你，你的魂都要被勾走了，元气大伤。", -10, -5, False),
        ("你遇到了女王的贴身壮汉，他觉得你眼神太挑衅，把你按在地上揍了一顿。", -25, 0, False),
        ("你在垃圾桶旁捡到一瓶不知名的粉色液体，喝完后你发现自己长出了胸毛（且是粉色的）。", 10, -10, False),
        ("你遇到一个花枝招展的小美女，她向你撒粉，你醒来发现自己躺在手术台上准备被‘去势’，好在跑得快。", -40, 0, False)
    ],
    "白天_尝试逃跑": [
        ("你试图翻墙，结果墙上通了高压电，你被电成了焦炭。外焦里嫩。", 0, 0, True),  # 暴毙
        ("你钻狗洞被卡住，被女王养的藏獒舔了一整天的脸和屁股，很爽，但脸部严重脱皮。", -20, -10, False),
        ("你伪装成垃圾桶，结果被垃圾车司机拉到荒郊野外干了一顿又送了回来。", -30, -5, False)
    ],
    "晚上_睡觉回血": [
        ("你睡得正香，隔壁奶0爬上你的床非要给你‘讲故事’，你被折腾了一宿没合眼。", -15, 10, False),
        ("你梦见自己回到了家乡，结果女王突然出现在梦里把你吓醒，吓得你阳痿了三天，女王很不满。", -10, -5, False),
        ("睡得太沉，被子被路过的壮汉偷走闻，你被冻感冒了。", -5, 0, False),
        ("一个完美的深度睡眠，你梦到了壮汉给你推拿，醒来后床单湿湿的，下面硬硬的，裤子脏脏的。", 40, 0, False)
    ],
    "晚上_深夜溜达": [
        ("你误入女王的秘药室，闻到了禁忌的香气，你的身体发生了不可名状的变异。", 20, -20, False),
        ("你在池塘边遇到一个正在洗澡的壮汉，你偷走了他的内裤导管，他咆哮着追上你，狠狠干了你一顿。", -20, 0, False),
        ("深夜遇到了正在梦游的女王，她把你当成了她死去的爱犬，对你百般羞辱，你很爽。", 10, 30, False),
        ("你试图偷窥一个小美女洗澡，结果被箭弩手射中了屁股。", -30, -10, False)
    ],
    "晚上_偷情作死": [
        ("你和女王最宠爱的那个男宠偷情，被女王当场撞破，女王冷笑着把你赏给了门口的保安团。", 0, 0, True),  # 暴毙
        ("你和奶0深夜在屋顶看星星，结果屋顶塌了，你摔进了女王怀里。", -30, -10, False),
        ("你勾搭上了壮汉统领，他为了奖励你，带你练习了一整晚，精疲力尽。", -25, -15, False)
    ]
}
