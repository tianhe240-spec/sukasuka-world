...
EVENTS = {
    "白天_老老实实待着": [
        ...
        ("你因为太老实，被路过的壮汉当成软柿子，抓去快活了一天，肛门松弛度增加。", -10, -5, False)
    ],
    "白天_出去闲逛": [
        ("你路过禁地‘榨汁间’，好奇往里看了一眼，结果被保安发现，当场被做成了肉饼。", 0, 0, True),  # 暴毙
        ("你遇到了一个奶0，他娇媚地看着你，你的魂都要被勾走了。", 20, -5, False),
        ("你遇到了女王的贴身壮汉，他觉得你眼神太挑衅，把你按在地上揍了一顿。", -15, 0, False),
        ("你在垃圾桶旁捡到一瓶不知名的粉色液体，喝完后你发现自己长出了胸毛（且是粉色的）。", 10, 40, False),
    ...
    "晚上_睡觉回血": [
        ("你睡得正香，隔壁奶0爬上你的床非要给你‘讲故事’，你被折腾了一宿没合眼，但很爽，精神极佳。", 20, 0, False),
        ("你梦见自己回到了家乡，结果女王突然出现在梦里把你吓醒，吓得你阳痿了三天，女王很不满，但你这几天得到了休息。", 10, -5, False),
        ("睡得太沉，被子被路过的壮汉偷走闻，你被冻感冒了。", -5, 0, False),
        ("一个完美的深度睡眠，你梦到了壮汉给你推拿，醒来后床单湿湿的，下面硬硬的，裤子脏脏的，女王以为你梦到她，大喜。", 40, 20, False)
    ],
    "晚上_深夜溜达": [
        ("你误入女王的秘药室，闻到了禁忌的香气，你的身体发生了不可名状的变异。", 20, 20, False),
        ("你在池塘边遇到一个正在洗澡的壮汉，你偷走了他的内裤导管，他咆哮着追上你，狠狠干了你一顿。", -10, 0, False),
        ("深夜遇到了正在梦游的女王，她把你当成了她死去的爱犬，对你百般羞辱，你很爽。", 10, 30, False),
        ("你试图偷窥一个小美女洗澡，结果被箭弩手射中了屁股。", -10, 0, False)
    ],
    "晚上_偷情作死": [
